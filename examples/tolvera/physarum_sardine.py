...
def param_loop(d=16, i=0):
    ...
    physarum.substep[None]       = P('1,10,9,4,3,7,5,8',i) # 10
    a(param_loop, d=8, i=i+1)

hush(param_loop)

physarum.sense_angle[None] = 0.20 * np.pi # 0.10 * np.pi
physarum.sense_dist[None]  = 100.0 # 40.0
physarum.evaporation[None] = 0.95 # 0.95 # 0-1
physarum.move_angle[None]  = 0.6 * np.pi # 0.2 * np.pi
physarum.move_step[None]   = 16 # 8
physarum.substep[None]     = 1 # 1
