...
@ti.data_oriented
class CV:
    def __init__(self, x=1920,y=1080, ggui_fps_limit=120, substeps=2, camera=True, device=0, invert=True, colormode='g') -> None:
        self.x, self.y = x, y
        self.ggui_fps_limit = ggui_fps_limit
        self.substeps = substeps # slow down camera reads
