...
class Boids(Particles):
    ...
    def _step(self, b: int):
        ...
        if n != 0:
            ...
            sep_species = sep_species/n * fear#self.fear[None]
...
def main():
    ...
    # boids = Boids(x=1024, n=128, species=1, separate=0.1, align=1.0, cohere=1.0, fear=0.0, dt=1, radius=30.0, speed=3.0, colormode='g', size=2)
    # boids = Boids(x=1024, n=1024, species=10, separate=1.0, align=0.0, cohere=0.0, fear=0.0, dt=1, radius=30.0, speed=3.0, colormode='g', size=2)
